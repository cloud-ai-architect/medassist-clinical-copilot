"""Lambda handler for clinician feedback.

Captures the clinician's verdict on a draft. This is the human-in-the-loop
...
def _record(data: dict) -> dict:
    ...
    if data.get("clinician_notes"):
        item["clinician_notes"] = {"S": str(data["clinician_notes"])[:4000]}
